...
TEST_CASE("Test name", "[Tag1][Tag2]...")
{
	...
	std::vector<string> dic1 = { "hot","dot","dog","lot","log","cog" };
	REQUIRE( s.ladderLength("hit", "cog", dic1) == 5 );

	std::vector<string> dic2 = { "hot","dot","dog","lot","log" };
	REQUIRE( s.ladderLength("hit", "cog", dic2) == 0 );
}
